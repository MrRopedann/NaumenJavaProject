...
import njp.NaumenJavaProject.forms.SelectRecordsForm;
...
public class MainController {
    ...
    public ModelAndView selectRecord(@ModelAttribute SelectRecordsForm selectRecordsForm){
        ModelAndView mav = new ModelAndView();
        mav.setViewName("../static/index");
        UsersServices usersServices = new UsersServices();
        List <Record> records = usersServices.selectRecords(selectRecordsForm.getFirstDate(), selectRecordsForm.getSecondDate());
